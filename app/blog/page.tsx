...
//   if (leetcodeLoading || gfgLoading) {
//     return <div>Loading...</div>; // Prevents hydration mismatch by rendering a consistent loading state
//   }
          ...
          <div className="card-content">
            ...
            {gfgLoading ? (
              ...
              <div>
                ...
                <p className="text-green-400 text-sm md:text-lg">
                  𝙀𝙖𝙨𝙮 𝙎𝙤𝙡𝙫𝙚𝙙: {gfgData.EasyProblemsSolved}
                </p>
                <p className="text-yellow-500 text-sm md:text-lg">
                  𝙈𝙚𝙙𝙞𝙪𝙢 𝙎𝙤𝙡𝙫𝙚𝙙: {gfgData.MediumProblemsSolved}
                </p>
                <p className="text-red-600 text-sm md:text-lg">
                  𝙃𝙖𝙧𝙙 𝙎𝙤𝙡𝙫𝙚𝙙: {gfgData.HardProblemsSolved}
                </p>
                <a
                  href="https://www.geeksforgeeks.org/user/shobhit_singh_gfg/"
                  className="text-green-400 hover:text-green-800"
